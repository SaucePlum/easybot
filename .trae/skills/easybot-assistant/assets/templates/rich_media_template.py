...
import os
from easybot import Bot, Model, MessagesModel, CommandValidScenes
...
async def send_embed(msg: Model.MessageBase):
...
async def send_markdown(msg: Model.MessageBase):
...
async def send_keyboard(msg: Model.MessageBase):
    md = MessagesModel.MessageMarkdown(
        content="请选择操作：",
        keyboard_content={
            "rows": [
